...
namespace BillVerification_WPF.Model
{
    class BICS_Carrier
    {
        ...
        // Constructor
        public BICS_Carrier(string trafficStart, string trafficEnd, string productName, string timeDifference, string destOperatorCommercialName,
            ...
            int numberOfCalls, decimal numberOfUnits, decimal unitTariff, string tariffValidityDate, string currency, decimal amount,
